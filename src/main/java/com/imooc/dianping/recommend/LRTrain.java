...
public class LRTrain {
    public static void main(String[] args) throws IOException {
        ...
        //加载特征及label训练文件
        JavaRDD<String> csvFile = spark.read().textFile("file:///Users/chenxuzhuang/mooc/devtool/data/feature.csv").toJavaRDD();
        ...
        lrModel.save("file:///Users/chenxuzhuang/mooc/devtool/data/lrmode");
