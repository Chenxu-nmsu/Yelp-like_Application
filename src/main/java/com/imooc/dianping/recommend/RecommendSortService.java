...
public class RecommendSortService {
    ...
    public void init(){
        ...
        lrModel = LogisticRegressionModel.load("file:///Users/chenxuzhuang/mooc/devtool/data/lrmode");
        gbtClassificationModel = GBTClassificationModel.load("file:///Users/chenxuzhuang/mooc/devtool/data/gbdtmode");
    }
