...
public class GBDTTrain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //加载特征以及label训练文件
        JavaRDD<String> csvFile = sparkSession.read().textFile("file:///Users/chenxuzhuang/mooc/devtool/data/feature.csv").toJavaRDD();
        ...
        gbtClassificationModel.save("file:///Users/chenxuzhuang/mooc/devtool/data/gbdtmode");
